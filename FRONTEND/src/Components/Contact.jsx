...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://getform.io/f/avrykxoa', {
        method: 'POST',
        headers: {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-black overflow-hidden">
      ...
      <div className="relative z-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20">
        {/* Header Section */}
        <div className="text-center mb-8 sm:mb-12 lg:mb-20 space-y-4 sm:space-y-6 pt-16">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-6 sm:mt-8 px-4">
            {['Web Development', 'UI/UX Design', 'AR/VR', 'WEB3 & Blockchain'].map((skill, index) => (
              <span
                key={index}
